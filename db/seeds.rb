...
#Party/Greetings
phrase_19 = Phrase.create(expression: "What's up y'all?", image: "sup", tags:['Greetings'], suggestions: ["", ""])
phrase_20 = Phrase.create(expression: "Yo", image: "yo", tags:['Greetings'], suggestions: ["", ""])
phrase_21 = Phrase.create(expression: "What's good?", image: "hundred", tags:['Greetings'], suggestions: ["", ""])
phrase_22 = Phrase.create(expression: "Hi Everyone, my name is Bob", image: "sup", tags:['Greetings'], suggestions: ["", ""])
#Party/Jokes
phrase_23 = Phrase.create(expression: "A priest, a rabbit, and a monk walk into a bar. And the Rabbit says I think that I might be a typo", image: "rabbit", tags:['Jokes'], suggestions: ["", ""])
phrase_24 = Phrase.create(expression: "A photon checks into a hotel and is asked if he needs any help with his luggage. He says, 'No, I'm traveling light.'", image: "joke-1" , tags:['Jokes'], suggestions: ["", ""])
phrase_25 = Phrase.create(expression: "Did you hear oxygen went on a date with potasium? ........ It went OK", image: "joke-2" , tags:['Jokes'], suggestions: ["", ""])
#Party/Joe
phrase_26 = Phrase.create(expression: "What's up Bean?", image: "sup", tags:['Joe Friend'], suggestions: ["", ""])
phrase_27 = Phrase.create(expression: "How are your dogs?", image: "dog", tags:['Joe Friend'], suggestions: ["", ""])
phrase_28 = Phrase.create(expression: "Have you hear the new RTJ album?", image: "rtj" , tags:['Joe Friend'], suggestions: ["", ""])
phrase_29 = Phrase.create(expression: "How's school going?", image: "school", tags:['Joe Friend'], suggestions: ["", ""])
phrase_30 = Phrase.create(expression: "Do you want a drink?", image: "drink", tags:['Joe Friend'], suggestions: ["", ""])
#Party/Goodbyes
phrase_31 = Phrase.create(expression: "Peace", image: "peace" , tags:['Goodbyes'], suggestions: ["", ""])
phrase_32 = Phrase.create(expression: "Seeya!", image: "wave" , tags:['Goodbyes'], suggestions: ["", ""])
phrase_33 = Phrase.create(expression: "Byeeeeeeeeee", image: "wave" , tags:['Goodbyes'], suggestions: ["", ""])
phrase_34 = Phrase.create(expression: "Bye Felicia", image: "felicia" , tags:['Goodbyes'], suggestions: ["", ""])
#Quick Responses
